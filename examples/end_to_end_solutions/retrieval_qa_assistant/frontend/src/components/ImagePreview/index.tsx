...
import PreviewGroup, { context, icons } from './components/PreviewGroup';
        ...
        {isError ? (
          <div className={`${prefixCls}-errorPic`} style={{ height: '100%' }}>
            ...
            <div className={addPrefix('con')}>
              ...
              <span>{intl.formatMessage({ id: "imageLoadErr" })}</span>
            </div>
          </div>
        ) : (
          <>
            <img
              ...
              onDragStart={(event: React.DragEvent<HTMLImageElement>) => {
                ...
                message.error(intl.formatMessage({ id: "imageDragDisabledTip" }));
              }}
            />
          </>
        )}
